...
For the blog-level narrative (AI agent war stories, PR analysis, gitnapped stats), see [the archive blog article](index.md). This document focuses on architecture and engineering patterns.
