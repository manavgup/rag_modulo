...
- [LESSONS_LEARNED.md](architecture-decisions-and-patterns.md) — architecture decisions that paid off and didn't
- [Issue #773 — RAG quality investigation](traces/hallucination-pipeline-trace.md) — full pipeline trace of a hallucination
- [Issue #777 — DB query trace](traces/44-queries-to-5-db-trace.md) — 44 numbered SQL queries mapped to call sites
