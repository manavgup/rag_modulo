...
@pytest.fixture(scope="session")
def base_llm_parameters(
    base_user, session_llm_parameters_service: LLMParametersService, default_llm_parameters_input
) -> LLMParametersOutput:
...
def custom_llm_parameters(
    base_user, session_llm_parameters_service, custom_llm_parameters_input
) -> LLMParametersOutput:
...
@pytest.fixture
def multiple_llm_parameters(base_llm_parameters, custom_llm_parameters) -> dict[str, LLMParametersOutput]:
