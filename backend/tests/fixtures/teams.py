...
def base_team(team_service: TeamService) -> TeamOutput:
...
@pytest.fixture(scope="session")
def user_team(team_service: TeamService, base_team: TeamOutput, base_user: UserOutput) -> TeamOutput:
...
@pytest.fixture(scope="session")
def base_user_team(team_service: TeamService, base_team: TeamOutput, base_user: UserOutput) -> TeamOutput:
