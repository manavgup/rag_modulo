...
def test_create_duplicate_name(
    ...
    updated = test_parameters_service.create_or_update_parameters(base_user.id, test_llm_parameters)
...
@pytest.mark.atomic
def test_get_nonexistent_user_parameters(test_parameters_service: LLMParametersService):
...
@pytest.mark.atomic
def test_user_default_parameters_management(test_parameters_service: LLMParametersService, base_user: User):
...
def test_multiple_users_default_parameters(
    test_parameters_service: LLMParametersService, base_user: User, db_session: Session
):
