...
@pytest.fixture
def test_collection_with_files(db_session: Session, base_user: User) -> Collection:
    ...
    user_collection = UserCollection(user_id=base_user.id, collection_id=collection.id)
