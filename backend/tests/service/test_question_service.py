...
async def test_get_collection_questions(
    ...
    # Retrieve questions
    stored_questions = question_service.get_collection_questions(collection_id=base_collection.id)
...
async def test_suggest_questions_empty_llm_response(
    ...
    restrictive_template = PromptTemplateInput(
        ...
        example_inputs={"context": "Python is a programming language.", "num_questions": 3},
