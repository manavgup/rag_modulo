...
from backend.rag_solution.router.user_collection_router import router
...
class TestUserCollectionRouter(unittest.TestCase):
    ...
    @patch('backend.rag_solution.services.user_collection_service.UserCollectionService.add_user_to_collection')
    ...
    @patch('backend.rag_solution.services.user_collection_service.UserCollectionService.remove_user_from_collection')
    ...
    @patch('backend.rag_solution.services.user_collection_interaction_service.UserCollectionInteractionService.get_user_collections_with_files')
    ...
    @patch('backend.rag_solution.services.user_collection_service.UserCollectionService.get_collection_users')
    ...
    @patch('backend.rag_solution.services.user_collection_service.UserCollectionService.remove_all_users_from_collection')
