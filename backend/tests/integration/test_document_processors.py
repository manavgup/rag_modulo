...
PROCESSOR_CONFIGS = {
    'txt': {
        'class': TxtProcessor,
        'fixture': 'test_txt_path'
    },
    'pdf': {
        'class': PdfProcessor,
        'fixture': 'test_pdf_path'
    },
    'word': {
        'class': WordProcessor,
        'fixture': 'test_word_path'
    },
    'excel': {
        'class': ExcelProcessor,
        'fixture': 'test_excel_path'
    }
}
        ...
        def test_text_extraction(self, complex_test_pdf_path):
            with multiprocessing.Manager() as manager:
                ...
                with pymupdf.open(str(complex_test_pdf_path)) as doc:
                    ...
                    assert any("This is a test document." in block['content'] 
                             for block in page1_content if block['type'] == 'text')
