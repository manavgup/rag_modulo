"""Integration tests for collection database operations."""
...
def test_collection_database_connection():
...
@pytest.mark.integration
def test_collection_database_operations():
    ...
    # Test operations
    result = mock_db.execute("SELECT * FROM collections")
    assert len(result) == 1
...
@pytest.mark.integration
def test_collection_database_transactions():
    """Test collection database transactions."""
...
@pytest.mark.integration
def test_collection_database_error_handling():
    """Test collection database error handling."""
    # Mock database error
    mock_db = Mock()
    mock_db.execute.side_effect = Exception("Database error")
    
    with pytest.raises(Exception):
        mock_db.execute("SELECT * FROM collections")


@pytest.mark.integration
def test_collection_database_performance():
    """Test collection database performance."""
