...
@pytest.mark.unit
def test_collection_service_creation():
    """Test collection service creation with mocked dependencies."""
    mock_db = Mock()
    mock_settings = Mock()
...
@pytest.mark.unit
def test_collection_service_methods():
    """Test collection service methods with mocked dependencies."""
    mock_db = Mock()
    mock_settings = Mock()
...
@pytest.mark.unit
def test_collection_service_error_handling():
    """Test collection service error handling."""
    mock_db = Mock()
    mock_settings = Mock()
...
@pytest.mark.unit
def test_collection_service_validation():
    """Test collection service input validation."""
    mock_db = Mock()
    mock_settings = Mock()
...
@pytest.mark.unit
def test_collection_service_business_logic():
