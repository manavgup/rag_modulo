...
class TestRAGAPIClient:
    ...
    def config(self):
        ...
        return RAGConfig(api_url="http://localhost:8000", profile="test", auth_token="test-token")
    ...
    def test_get_request_success(self, mock_get, api_client, mock_response):
        ...
        mock_get.assert_called_once_with("http://localhost:8000/api/collections", headers={"Authorization": "Bearer test-token", "Content-Type": "application/json"}, params=None, timeout=30)
    ...
    def test_post_request_success(self, mock_post, api_client, mock_response):
        ...
        # Verify request
        mock_post.assert_called_once_with("http://localhost:8000/api/collections", headers={"Authorization": "Bearer test-token", "Content-Type": "application/json"}, json=data, timeout=30)
    ...
    def test_put_request_success(self, mock_put, api_client, mock_response):
        ...
        # Verify request
        mock_put.assert_called_once_with("http://localhost:8000/api/collections/123", headers={"Authorization": "Bearer test-token", "Content-Type": "application/json"}, json=data, timeout=30)
    ...
    def test_delete_request_success(self, mock_delete, api_client, mock_response):
        ...
        # Verify request
        mock_delete.assert_called_once_with("http://localhost:8000/api/collections/123", headers={"Authorization": "Bearer test-token", "Content-Type": "application/json"}, timeout=30)
    ...
    def test_query_parameters(self, mock_get, api_client, mock_response):
        ...
        mock_get.assert_called_once_with("http://localhost:8000/api/collections", headers={"Authorization": "Bearer test-token", "Content-Type": "application/json"}, params=params, timeout=30)
...
class TestCLICommandWrapper:
    ...
    def test_collections_list_command(self, mock_api_client):
        ...
        mock_api_client.get.return_value = {"collections": [{"id": "123", "name": "Test Collection", "status": "active"}, {"id": "456", "name": "Another Collection", "status": "active"}], "total": 2}
    ...
    def test_users_create_command(self, mock_api_client):
        ...
        # Mock API response
        mock_api_client.post.return_value = {"id": str(uuid4()), "email": "test@example.com", "name": "Test User", "role": "user"}
    ...
    def test_search_query_command(self, mock_api_client):
        ...
        # Mock API response
        mock_api_client.post.return_value = {"answer": "Test answer", "retrieved_chunks": [{"content": "Chunk 1", "score": 0.95}, {"content": "Chunk 2", "score": 0.87}], "confidence_score": 0.91}
        ...
        # Verify API call
        mock_api_client.post.assert_called_once_with("/api/search/query", data={"collection_id": "collection123", "query": "What is machine learning?"})
