...
from cli.search_test import search, _calculate_quality_score
...
class TestSearchCLI:
    ...
    def test_test_command_execution(self, runner, mock_services, mock_logger, tmp_path):
    ...
    def test_batch_test_command(self, runner, mock_services, mock_logger, tmp_path):
    ...
    def test_test_components_command(self, runner, mock_services, mock_logger):
...
class TestCLIIntegration:
    ...
    async def test_search_integration(self, db_session, test_collection, test_user):
        ...
        from cli.search_test import _test_search
