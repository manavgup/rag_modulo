...
class TestChainOfThoughtConfigSchema:
    ...
    def test_cot_config_schema_with_default_values(self):
        ...
        from rag_solution.schemas.chain_of_thought_schema importChainOfThoughtConfig
...
class TestQuestionDecompositionSchema:
    ...
    def test_decomposed_question_schema_creation(self):
        ...
        from rag_solution.schemas.chain_of_thought_schema importDecomposedQuestion
...
class TestReasoningStepSchema:
    ...
    def test_reasoning_step_schema_creation(self):
        ...
        from rag_solution.schemas.chain_of_thought_schema importReasoningStep
...
class TestChainOfThoughtOutputSchema:
    ...
    def test_cot_output_schema_confidence_range(self):
        ...
        from rag_solution.schemas.chain_of_thought_schema importChainOfThoughtOutput
...
class TestChainOfThoughtInputSchema:
    ...
    def test_cot_input_schema_creation(self):
        ...
        from rag_solution.schemas.chain_of_thought_schema importChainOfThoughtInput
        ...
        input_data = {
            ...
            "context_metadata": {
                "document_types": ["research_paper", "tutorial"],
        ...
        assert isinstance(cot_input.collection_id, UUID4)
        assert isinstance(cot_input.user_id, UUID4)
...
class TestQuestionClassificationSchema:
    ...
    def test_question_classification_schema_creation(self):
        ...
        from rag_solution.schemas.chain_of_thought_schema importQuestionClassification
