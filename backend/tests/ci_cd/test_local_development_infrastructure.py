...
class TestPyProjectTomlIntegration:
    ...
    def test_pyproject_toml_tool_configurations_validation(self):
        ...
        expected_tools = ["ruff", "ruff.lint", "mypy", "pytest.ini_options", "poetry", "interrogate", "pydocstyle"]
...
class TestMakefileIntegration:
    ...
    def test_makefile_quality_targets_integration(self):
        ...
        with patch("subprocess.run") as mock_subprocess:
            ...
            expected_targets = ["quick-check", "format-check", "lint-ruff", "check-fast", "quality", "security-check"]
...
class TestPreCommitHooksIntegration:
    ...
    def test_precommit_config_yaml_structure_validation(self):
        ...
        expected_hooks = ["trailing-whitespace", "end-of-file-fixer", "ruff", "ruff-format", "mypy", "check-github-workflows"]
    ...
    def test_precommit_hooks_execution_with_ci_cd_tests(self):
        ...
        expected_hook_results = {"trailing_whitespace": bool, "end_of_file_fixer": bool, "ruff": bool, "ruff_format": bool, "mypy": bool}
...
class TestGitHubActionsIntegration:
    ...
    def test_github_workflow_file_structure(self):
        ...
        expected_jobs = ["test-isolation", "lint-and-unit", "build", "api-tests", "integration-test", "report"]
    ...
    def test_github_actions_environment_variables_consistency(self):
        ...
        ci_env_vars = ["JWT_SECRET_KEY", "RAG_LLM", "WATSONX_INSTANCE_ID", "WATSONX_APIKEY", "WATSONX_URL", "VECTOR_DB", "MILVUS_HOST", "MILVUS_PORT", "EMBEDDING_MODEL", "DATA_DIR"]
...
class TestIntegrationWorkflow:
    ...
    def test_full_development_workflow_integration(self):
        ...
        expected_stages = {
            "local_development": {"pyproject_toml_valid": bool, "makefile_targets_work": bool, "poetry_env_setup": bool},
            "pre_commit": {"hooks_configured": bool, "hooks_executable": bool, "quality_checks_pass": bool},
            "ci_pipeline": {"workflow_triggers": bool, "environment_validated": bool, "services_healthy": bool, "tests_pass": bool},
            "deployment": {"images_built": bool, "ghcr_push_works": bool, "health_checks_pass": bool},
        }
    ...
    def test_ci_cd_improvements_backward_compatibility(self):
        ...
        compatibility_checks = ["existing_make_targets_work", "poetry_commands_unchanged", "test_discovery_unchanged", "environment_variables_compatible", "docker_compose_compatible"]
