...
class TestCIEnvironmentAuth:
    ...
    def test_oidc_skip_with_testing_true(self):
    ...
    def test_oidc_skip_with_skip_auth_true(self):
    ...
    def test_oidc_skip_with_development_mode_true(self):
    ...
    def test_oidc_not_skipped_in_production(self):
    ...
    @pytest.mark.asyncio
    async def test_auth_middleware_skip_in_ci(self):
    ...
    @pytest.mark.asyncio
    async def test_auth_middleware_requires_auth_in_production(self):
    ...
    def test_verify_jwt_token_with_mock_token(self):
...
class TestHealthEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_health_endpoint_accessible_without_auth(self):
...
class TestEnvironmentVariables:
    ...
    def test_multiple_env_combinations(self):
        ...
        for testing, skip_auth, dev_mode, should_skip in combinations:
            ...
            skip = (
                os.getenv("SKIP_AUTH", "false").lower() == "true" or
