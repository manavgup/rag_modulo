...
class TestSearchAndCollections(BaseTestRouter):
    ...
    @pytest.fixture
    def test_collection_data(self, base_user: UserOutput) -> dict[str, Any]:
    ...
    @pytest.fixture
    def test_search_input(self, base_collection: CollectionOutput) -> dict[str, str]:
        """Sample search input data."""
        return {"question": "What is this document about?", "collection_id": str(base_collection.id)}

    @pytest.fixture
    def test_search_context(self) -> dict[str, str]:
        """Sample search context data."""
        return {"user_role": "student", "language": "en", "detail_level": "high"}

    # Collection Management Tests
    @pytest.mark.asyncio
    async def test_create_collection(self, test_collection_data: dict[str, Any]) -> None:
    ...
    @pytest.mark.asyncio
    async def test_create_collection_with_files(self, base_user: UserOutput) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_collection(self, base_collection: CollectionOutput) -> None:
    ...
    @pytest.mark.asyncio
    def test_upload_files(self, base_user: UserOutput, base_collection: Any) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_files(self, base_collection: CollectionOutput, base_file: FileOutput) -> None:
    ...
    # Search Tests
    @pytest.mark.asyncio
    async def test_search_success(self, test_search_input: dict[str, str]) -> None:
    ...
    @pytest.mark.asyncio
    async def test_search_with_context(self, test_search_input: dict[str, str], test_search_context: dict[str, str]) -> None:
    ...
    @pytest.mark.asyncio
    async def test_search_collection_not_found(self, test_search_input: dict[str, str]) -> None:
    ...
    # Error Cases
    @pytest.mark.asyncio
    async def test_search_validation(self, test_search_input: dict[str, str]) -> None:
    ...
    # Authorization Tests
    @pytest.mark.asyncio
    async def test_unauthorized_access(self, test_search_input: dict[str, str]) -> None:  # noqa: ARG002
    ...
    @pytest.mark.asyncio
    async def test_access_unauthorized_collection(self, base_collection: CollectionOutput) -> None:
