...
class TestLLMConfiguration(BaseTestRouter):
    ...
    def test_template_data(self, base_user):
        ...
        return {
            ...
            "input_variables": {"context": "The context to consider", "question": "The question to answer"},
    ...
    async def test_get_user_parameters(self, base_user):
        ...
        # Create parameters
        create_response = self.post(f"/api/users/{base_user.id}/llm-parameters", json=test_params)
    ...
    async def test_invalid_parameters(self, base_user):
        ...
        response = self.post(f"/api/users/{base_user.id}/llm-parameters", json=invalid_data)
