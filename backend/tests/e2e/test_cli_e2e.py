...
class TestCLICompleteWorkflow:
    ...
    def test_complete_user_workflow(self, temp_profile_dir, test_credentials, sample_document):
        ...
        with patch('rag_solution.cli.auth.ProfileManager.profiles_dir', temp_profile_dir):
            ...
            create_result = main_cli([
                ...
                '--description', 'End-to-end CLI test collection',
                '--output', 'json'
            ])
            ...
            if create_result.exit_code == 0:
                ...
                upload_result = main_cli([
                    'documents', 'upload', collection_id, sample_document,
                    '--output', 'json'
                ])
                ...
                if upload_result.exit_code == 0:
                    ...
                    search_result = main_cli([
                        'search', 'query', collection_id,
    ...
    def test_cli_error_handling_workflow(self, temp_profile_dir):
        ...
        with patch('rag_solution.cli.auth.ProfileManager.profiles_dir', temp_profile_dir):
            ...
            nonexistent_file = main_cli([
                'documents', 'upload', 'some-collection', '/nonexistent/file.txt'
            ])
