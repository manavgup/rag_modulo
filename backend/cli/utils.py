...
def evaluate_answer_quality(answer: str, expected_keywords: Optional[List[str]] = None) -> Dict[str, Any]:
...
def generate_quality_report(results: List[Dict[str, Any]], output_path: Optional[str] = None) -> str:
