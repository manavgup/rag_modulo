...
class LLMModelService:
    ...
    def create_model(self, model_input: LLMModelInput) -> LLMModelOutput:
        ...
        try:
            ...
            raise LLMProviderError(
                provider=str(model_input.provider_id),
                error_type="model_creation",
                message=str(e)
            )
    
    def set_default_model(self, model_id: UUID) -> Optional[LLMModelOutput]:
    ...
    def update_model(self, model_id: UUID, updates: Dict[str, Any]) -> Optional[LLMModelOutput]:
