...
class UserTeamService:
    ...
    def get_user_team(self, user_id: UUID4, team_id: UUID4) -> UserTeamOutput:
        return self.user_team_repository.get_user_team(user_id, team_id)

    def update_user_role_in_team(self, user_id: UUID4, team_id: UUID4, role: str) -> UserTeamOutput:
