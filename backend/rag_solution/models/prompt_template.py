from sqlalchemy import Column, Enum, String, Text, Boolean, DateTime, ForeignKey, Integer, JSON
...
class PromptTemplate(Base):
    ...
    template_type = Column(SQLAlchemyEnum(PromptTemplateType, name='prompttemplatetype', create_type=False), nullable=False)
