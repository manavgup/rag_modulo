...
from vectordbs.data_types import (Document, DocumentMetadataFilter,
                                  QueryResult, QueryWithEmbedding)
...
class VectorStore(ABC):
    ...
    def retrieve_documents(
        ...
        Returns:
            A QueryResult object containing the retrieved documents
            and their scores.
        """
    ...
    def query(
        ...
        Returns:
            A QueryResult object containing the retrieved documents and their
            scores.
        """
