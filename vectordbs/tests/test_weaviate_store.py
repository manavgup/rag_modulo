...
from vectordbs.data_types import Document, DocumentChunk, DocumentChunkMetadata, Source, QueryWithEmbedding, DocumentMetadataFilter, Embeddings
import json
...
async def test_retrieve_documents_with_query_embedding(weaviate_store):
    ...
    query_results = weaviate_store.retrieve_documents(query_embedding, 'test_collection')
