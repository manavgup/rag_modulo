...
from rag_solution.data_ingestion.chunking import simple_chunking, semantic_chunking, token_based_chunking
...
async def test_document_store():
    ...
    # Create test files
    test_files = [
        "backend/tests/test_files/test1.txt",
        "backend/tests/test_files/test2.pdf"
    ]
