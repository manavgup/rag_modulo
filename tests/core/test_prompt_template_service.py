...
def test_initialize_default_templates(template_service, sample_user_id):
    ...
    template_service.repository.create_or_update_by_user_id = Mock(side_effect=[
    ...
    rag_template, question_template = template_service.initialize_default_templates(
        sample_user_id,
        "watsonx"
    )
...
def test_get_by_type(template_service, sample_user_id, sample_template_model):
    ...
    result = template_service.get_by_type(
