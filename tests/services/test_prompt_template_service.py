...
def test_create_or_update_template(
    ...
    updated_input = test_prompt_template.model_copy(update={
        "system_prompt": "Updated system prompt"
    })
    updated = prompt_template_service.create_or_update_template(
        base_user.id,
        updated_input
    )
...
def test_get_by_id(
    ...
    created = prompt_template_service.create_or_update_template(
        base_user.id,
        test_prompt_template
    )
...
def test_get_by_type(
    ...
    prompt_template_service.create_or_update_template(
        base_user.id,
        test_prompt_template
    )
    
    template = prompt_template_service.get_by_type(
...
def test_apply_custom_context_strategy(
    ...
    template_with_strategy = test_prompt_template.model_copy(update={
        "context_strategy": {
            "max_chunks": 2,
            "chunk_separator": " | ",
            "ordering": "relevance",
