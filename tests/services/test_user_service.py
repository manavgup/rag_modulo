...
@pytest.mark.atomic
def test_create_user_duplicate_ibm_id(
    user_service,
...
def test_update_user(
    ...
    update_input = UserInput(
        ibm_id=base_user.ibm_id,
...
def test_list_users(
    ...
    other_user = user_service.create_user(UserInput(
        ibm_id=f"other_user_{uuid4()}",
