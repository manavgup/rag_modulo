...
async def test_pipeline_with_content(
    ...
    test_queries = [
        ...
        {
            "question": "What are the main features of Django?",
            "expected_terms": ["admin", "orm", "framework"]
        },
        {
            "question": "How can Python performance be optimized?",
            "expected_terms": ["cython", "asyncio"]
        },
        {
...
def test_collection_default_pipeline(
    pipeline_service,
    base_collection,
    default_pipeline_config
):
